...
<div class="" id="home">
    ...
    <div class="container mt-5">
        <!-- row -->
        <% BlogOffer blogOffer = (BlogOffer) request.getAttribute("blogOffer");
        %>
        <div class="row tm-content-row">
            ...
            <div class="tm-block-col tm-col-account-settings">
                <div class="tm-bg-primary-dark tm-block tm-block-settings">
                    ...
                    <form action="admin-blog-offer-edit" method="post" class="tm-signup-form row">
                        <input value="<%=blogOffer.getIdBv()%>" name="idBv" type="hidden">
                        <div class="form-group col-lg-6">
                            <label for="name">Tiêu đề</label>
                            <input
                                    id="name"
                                    name="topic"
                                    value="<%=blogOffer.getTopic()%>"
                                    type="text"
                        ...
                        <div class="col-12">
                            <a
                                    href="admin-blog-offer-delete?idBv=<%=blogOffer.getIdBv()%>"
                                    class="btn btn-primary btn-block text-uppercase"
                            >
                                Xóa blog
                            </a>
