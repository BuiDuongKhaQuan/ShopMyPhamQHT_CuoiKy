        ...
        <div class="row tm-content-row">
            ...
            <div class="tm-block-col tm-col-account-settings">
                <div class="tm-bg-primary-dark tm-block tm-block-settings">
                    ...
                    <form action="admin-product-category-edit" method="post" class="tm-signup-form row">
                        <input value="<%=categories.getIdC()%>" name="idC" type="hidden">
                        <div class="form-group col-lg-6">
                            <label for="name">Tên</label>
                            <input
                                    id="name"
                                    name="name"
                                    value="<%=categories.getNameC()%>"
                                    type="text"
                        ...
                        <div class="form-group col-lg-6">
                            <label class="tm-hide-sm">&nbsp;</label>
                            <a
                                    href="admin-product-category-delete?cid=<%=categories.getIdC()%>"
                                    class="btn btn-primary btn-block text-uppercase"
                            >
                                Xóa danh mục
                            </a>
